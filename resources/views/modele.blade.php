            ...
            @auth
                <footer class="footer mt-auto py-3 bg-light fixed-bottom">
                    <div class="container d-flex">
                        <p class="text-muted">Vous êtes connecté en tant que {{Auth::user()->nom}} {{Auth::user()->prenom}} | {{Auth::user()->type}}
                            <a style="margin-left:10px;" class="btn btn-outline-secondary" href="{{route('logout')}}">Deconnexion</a>
                        </p>
