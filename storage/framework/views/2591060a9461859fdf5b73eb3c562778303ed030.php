...
<?php $__env->startSection('contents'); ?>
    ...
    <?php if (! (empty($cours))): ?>
        <div class="container-sm">
            <!-----------------------------Btn Back------------------------------>
            <a class="btn btn-info" style="margin-top:20px;" href="<?php echo e(route('enseignant.showSeance')); ?>"><i class="bi bi-arrow-left-circle-fill"></i> Back</a>
...
<?php echo $__env->make('modele', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\projet2022\resources\views/enseignant/VoirListeCoursEnseignant.blade.php ENDPATH**/ ?>