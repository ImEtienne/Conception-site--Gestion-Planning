...
<?php $__env->startSection('contents'); ?>
    ...
    <div class="container-sm">
        ...
        <form action="<?php echo e(route('admin.cours.edit',['id'=>$cours->id])); ?>" method="POST">
            <div class="mb-3">
                <label for="formGroupExampleInput2" class="form-label">Intitule</label>
                <input type="text" class="form-control" name="intitule" id="formGroupExampleInput2" placeholder="intitule..." value="<?php echo e(old('intitule',$cours->intitule)); ?>">
            </div>
...
<?php echo $__env->make('modele', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\projet2022\resources\views/admin/cours/edit.blade.php ENDPATH**/ ?>