            ...
            <table class="table table-hover caption-top" style="box-shadow: 5px 10px 20px rgba(0,0,0, 0.3);">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $etudiants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $etudiant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td><a type="button" class="btn btn-warning" href="<?php echo e(route('gestionnaire.dissocier', ['id'=>$etudiant->id])); ?>"><i class="bi bi-trash3-fill"></i>&nbsp;Dissocier</a></td>
                        <td><a type="button" class="btn btn-dark" href="<?php echo e(route('gestionnaire.listePresenceDetaille', ['id'=>$etudiant->id])); ?>"><i class="bi bi-eye"></i>&nbsp;Voir les détailles</a></td>
                    </tr>
...
<?php echo $__env->make('modele', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\projet2022\resources\views/gestionnaire/showAssociationEtudiant.blade.php ENDPATH**/ ?>