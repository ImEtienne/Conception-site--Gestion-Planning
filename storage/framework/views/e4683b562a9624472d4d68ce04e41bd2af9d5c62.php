...
<?php $__env->startSection('contents'); ?>
    ...
    <div class="container-sm">
        ...
        <form method="POST">
            ...
            <input class="btn btn-success" type="submit" name="associer" value="Dissocier">
            <?php echo csrf_field(); ?>
        </form>
    </div>
...
<?php echo $__env->make('modele', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\projet2022\resources\views/gestionnaire/Seances/dissocieEtudiantPlusieurs.blade.php ENDPATH**/ ?>