<?php $__env->startSection('title', 'Accueil - Enseignant'); ?>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <?php if(Auth::user()->type == 'admin'): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('admin.home')); ?>">Back To Home Admin</a>
                            <li>
                    <?php endif; ?>
...
<?php echo $__env->make('modele', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\projet2022\resources\views/enseignant/home.blade.php ENDPATH**/ ?>