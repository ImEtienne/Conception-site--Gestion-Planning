        ...
        <div class="container-sm">
            ...
            <table class="table table-hover caption-top" style="box-shadow: 5px 10px 20px rgba(0,0,0, 0.3);">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $presences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $presence): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><?php echo e($seances->id); ?></td>
                        <td><?php echo e($seances->cours_id); ?></td>
                        <td><?php echo e($seances->date_debut); ?></td>
                        <td><?php echo e($seances->date_fin); ?></td>
...
<?php echo $__env->make('modele', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\projet2022\resources\views/gestionnaire/Seances/presenceEtudiantParSeance.blade.php ENDPATH**/ ?>