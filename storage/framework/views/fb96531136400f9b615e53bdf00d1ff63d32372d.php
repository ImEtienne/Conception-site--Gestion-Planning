<?php $__env->startSection('title', 'Modifier la séance'); ?>
...
<?php $__env->startSection('contents'); ?>
    ...
    <div class="container-sm">
        ...
        <form action='<?php echo e(route('gestionnaire.seance.edit',['id'=>$seances->id])); ?>' method="POST">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="datetime-local" class="form-control" name="date_debut" id="formGroupExampleInput" value="<?php echo e(old('date_debut',$seances->date_debut)); ?>">
            </div>

            <div class="mb-3">
                <label for="formGroupExampleInput" class="form-label">Date de fin : </label>
                <input type="datetime-local" class="form-control" name="date_fin" id="formGroupExampleInput" value="<?php echo e(old('date_fin',$seances->date_fin)); ?>">
            </div>
...
<?php echo $__env->make('modele', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\projet2022\resources\views/gestionnaire/Seances/editSeance.blade.php ENDPATH**/ ?>