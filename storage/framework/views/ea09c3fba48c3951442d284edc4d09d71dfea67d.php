...
<?php $__env->startSection('contents'); ?>
    ...
    <div class="container-sm">
        ...
        <form action='<?php echo e(route('enseignant.pointer.etudiant', [$seances->id])); ?>' method="POST">
            <div class="mb-3">
                <label for="formGroupExampleInput" class="form-label">ID</label>
                <input type="text" class="form-control" name="id" id="formGroupExampleInput" readonly value="<?php echo e(old('cours_id',$seances->id)); ?>">
            </div>

            <div class="mb-3">
                <label for="formGroupExampleInput" class="form-label">Cours_id</label>
                <input type="text" class="form-control" name="cours" id="formGroupExampleInput" readonly value="<?php echo e(old('cours_id',$seances->cours_id)); ?>">
            </div>

            <div class="mb-3">
                <label for="formGroupExampleInput" class="form-label">Date de début : </label>
                <input type="datetime-local" class="form-control" name="date_debut" id="formGroupExampleInput" readonly value="<?php echo e(old('date_debut',$seances->date_debut)); ?>">
            </div>

            <div class="mb-3">
                <label for="formGroupExampleInput" class="form-label">Date de fin : </label>
                <input type="datetime-local" class="form-control" name="date_fin" id="formGroupExampleInput" readonly value="<?php echo e(old('date_fin',$seances->date_fin)); ?>">
            </div>
            ...
            <select name="id_etudiant">
                ...
                <?php $__currentLoopData = $etudiants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $etudiant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option title="<?php echo e($etudiant->id); ?>" value="<?php echo e($etudiant->id); ?>"><?php echo e($etudiant->nom); ?> <?php echo e($etudiant->prenom); ?></option>
...
<?php echo $__env->make('modele', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\projet2022\resources\views/enseignant/pointage/pointageEtudiant.blade.php ENDPATH**/ ?>